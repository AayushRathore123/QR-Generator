...
export class RegisterComponent {
  ...
  onSubmit(): void {
    ...
    if (this.registerForm.valid && this.registerForm.controls['confirmpassword'].value == this.registerForm.controls['password'].value) {
      ...
      const password =  this.encryptdecryptservice.encrypt(this.registerForm.controls['password'].value);
      const firstname = this.registerForm.controls['firstname'].value.trim();
      const lastname = this.registerForm.controls['firstname'].value.trim();
      const gender = this.registerForm.controls['firstname'].value.trim();
      const dob = this.registerForm.controls['firstname'].value.trim();
console.log("pass",password)
console.log("pass",this.encryptdecryptservice.decrypt(password))
